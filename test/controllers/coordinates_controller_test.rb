...
class CoordinatesControllerTest < ActionController::TestCase
  ...
  test "should create coordinate" do
    assert_difference('Coordinate.count') do
      post :create, coordinate: { disposition: @coordinate.disposition, name: @coordinate.name, order: @coordinate.order, table_id: @coordinate.table_id }
    end
  ...
  test "should update coordinate" do
    patch :update, id: @coordinate, coordinate: { disposition: @coordinate.disposition, name: @coordinate.name, order: @coordinate.order, table_id: @coordinate.table_id }
    assert_redirected_to coordinate_path(assigns(:coordinate))
  end
